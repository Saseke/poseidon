package com.yoke.poseidon.generate;
...
public class CodeGeneration {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(
				"/media/code/java/project/Poseidon-Java/psd-web-item/src/main/java");
		...
		strategy.setInclude("db_item", "db_item_cat", "db_panel", "db_panel_content");
